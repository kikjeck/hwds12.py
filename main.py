...
def main():
    ...
    #
    # """
    # # fig = px.bar(smry[smry.Category == cat].sort_values(var), x="Item", y=["gold", "silver", "bronze"], title="Wide-Form Input")
    # fig = px.bar(smry[smry.Category == cat].sort_values(var), x="Item", y=var, height=400)
    # st.plotly_chart(fig)
